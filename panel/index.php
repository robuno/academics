...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mt-2 mt-lg-0">
      ...
      <li class="Nav-item">
        <a class="nav-link" href="login.php?action=exit">Exit</a>
      </li>
    </ul>
  </div>
</nav>
        ...
        <div class="row">
            <div class="col-md" id="panel">
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                echo '<p>Logged Mail: '.$sessionMail.'</p>';
              ?>
              <div class="index-panel-first">
                <li>You can add a new publication, course, research and announcement.</li>
                <li>The changes you did in contact panel are visible on main page and contact page.</li>
                <li><a href="https://github.com/robuno/academics">You can contact the creator of the project for any problems and suggestions!</a></li>
              </div>           
              </div>
