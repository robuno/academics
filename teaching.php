  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item active">
          <a class="nav-link" href="teaching.php">Teaching<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        ...
        <div class="row">
            <div class="col-md" id="teaching">
              ...
              while($row = mysqli_fetch_array($result)) {
                  echo '<li>
                  <a href="'.$row["courselink"].'" target="_blank">'.$row["title"].'</a>
                  <p>'.$row["explanation"].'</p>
